...
addpath(root);
addpath(fullfile(root,'aib'       )) ;
addpath(fullfile(root,'geometry'  )) ;
addpath(fullfile(root,'imop'      )) ;
addpath(fullfile(root,'kmeans'    )) ;
addpath(fullfile(root,'misc'      )) ;
addpath(fullfile(root,'mser'      )) ;
addpath(fullfile(root,'plotop'    )) ;
addpath(fullfile(root,'quickshift')) ;
addpath(fullfile(root,'sift'      )) ;
addpath(fullfile(root,'special'   )) ;
addpath(fullfile(root,'slic'      )) ;
addpath(fullfile(root,bindir      )) ;

if noprefix
  addpath(fullfile(root,'noprefix')) ;
end
